...
export const getCurrentBreakpoint = (width = getViewport().width) => {
...
export async function getThumb(id) {
  ...
  return thumbnails.data[0].sizes[thumbnails.data[0].sizes.findIndex(size => size.width === 640)].link;
}
...
export const roundToNearest = (num, multiple) => {
